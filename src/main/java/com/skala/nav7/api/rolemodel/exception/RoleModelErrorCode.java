...
@Getter
@AllArgsConstructor
public enum RoleModelErrorCode implements BaseErrorCode {
    ROLE_MODEL_JSON_PARSING_ERROR(HttpStatus.BAD_REQUEST, "FAST_API_JSON_500", "RoleModel JSON 파싱 중 오류가 발생했습니다."),
    ;
